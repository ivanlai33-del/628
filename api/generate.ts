...
- LABEL the Six Roles as "Tactical Advantages" (戰術優點):
  1. Strategic Advantage (Internal: Commander)
  2. Technical Advantage (Internal: Engineering)
  3. Knowledge Advantage (Internal: Research)
  4. Flow Advantage (Internal: UX)
  5. Quantitative Advantage (Internal: Data/Finance)
  6. Narrative Advantage (Internal: Content)
...
Identification of the precise 20% of work that will yield 80% impact. These are the mission-critical checkpoints.
